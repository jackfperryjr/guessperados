...
export class BootScene extends Phaser.Scene {
  ...
  private genObjects() {
    ...
    // Bomb
    const bm = this.g()
    bm.fillStyle(0x37474f); bm.fillCircle(8, 10, 8)
    bm.fillStyle(0x607d8b); bm.fillCircle(6, 8, 3)
    bm.fillStyle(0xff8f00); bm.fillRect(7, 2, 3, 4)
    bm.generateTexture('bomb', 16, 16); bm.destroy()
