...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('item-worm',      'assets/npcs/worm.png',      { frameWidth: 64, frameHeight: 64 })
    this.load.spritesheet('item-roly-poly', 'assets/npcs/roly_poly.png', { frameWidth: 64, frameHeight: 64 })
